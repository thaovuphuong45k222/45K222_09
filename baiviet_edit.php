                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input  type="text" name="mota"  value="<?=$oneRecode['mota']?>" parsley-trigger="change" required
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input  type="number" name="luotxem"  value="<?=$oneRecode['luotxem']?>" parsley-trigger="change" required
                                           ...
                                           <div class="row">
                                               <div class="col-lg-3">
                                                   <div class="form-group">
                                                       <div class="checkbox">
                                                           <input id="remember-1" <?php ($oneRecode['public'] == 1) ? "checked" : ''; ?>  type="checkbox" name="public" value="1" data-parsley-multiple="remember-1">
