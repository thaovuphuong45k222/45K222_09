                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="?ctrl=layso&act=addnew">Thêm Mới</a></li>
                                    <li><a href="?ctrl=layso&act=index">Danh Sách</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="?ctrl=baiviet&act=addnew">Thêm Mới</a></li>
                                    <li><a href="?ctrl=baiviet&act=index">Danh Sách</a></li>
                                </ul>
                            </li>
